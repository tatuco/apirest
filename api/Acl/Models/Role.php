...
namespace Api\Acl\Models;

use Config;
use Illuminate\Database\Eloquent\Model;
use Api\Acl\Traits\PermissionTrait;
...
class Role extends Model
{
    ...
    {
        return $this->belongsToMany('Api\Users\Models\User')->withTimestamps();
    }
    ...
    {
        $userClass = config('\Api\User\Models\User');
